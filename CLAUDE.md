...
## 프로젝트 개요
AI 코딩 도구들이 흔히 저지르는 뻔하고 답답한 UI 실수를 원천 차단하고 프로급 디자인 품질을 보장하는 "AI 디자인 품질 보증 언어"
어떤 AI 모델을 쓰더라도 군더더기 없는 미니멀리즘과 세련된 사용자 경험(UX) 원칙을 엄격하게 적용하여 결과물 생성
찍어낸 듯 뻔한 AI 스타일을 탈피하여 진짜 사람 디자이너가 정성스레 다듬은 듯한 독창적인 제품을 완성
